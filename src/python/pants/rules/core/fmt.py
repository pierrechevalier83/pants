...
class FormatTarget:
    ...
    @staticmethod
    def is_formattable(target_adaptor: TargetAdaptor, *, union_membership: UnionMembership) -> bool:
        return (
...
async def fmt(
    ...
    individual_results = [
        result for aggregated_result in aggregated_results for result in aggregated_result.results
    ]
