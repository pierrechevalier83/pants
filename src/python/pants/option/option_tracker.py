...
class OptionTracker:
    ...
    OptionHistoryRecord = namedtuple(
        "OptionHistoryRecord", ["value", "rank", "deprecation_version", "details"]
    )
    ...
    class OptionHistory:
        ...
        def was_overridden(self):
            ...
            if len(self.values) < 2:
                return False
            return (
                self.latest.rank > RankedValue.HARDCODED and self.values[-2].rank > RankedValue.NONE
            )
