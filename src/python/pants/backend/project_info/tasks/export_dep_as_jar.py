...
class ExportDepAsJar(ConsoleTask):
  ...
  """
    ...
    def _process_target(
        self, current_target, modulizable_target_set, resource_target_map, runtime_classpath
    ):
        """
    ...
    def _get_targets_to_make_into_modules(self, target_roots_set):
        ...
        dependees_of_target_roots = self.context.build_graph.transitive_dependees_of_addresses(
    ...
    """
        ...
        for target in modulizable_targets:
            info = self._process_target(
                target, modulizable_targets, resource_target_map, runtime_classpath
            )
