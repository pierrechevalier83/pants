...
class PexRequirements:
    ...
    def create_from_adaptors(
        cls, adaptors: Tuple[TargetAdaptor, ...], additional_requirements: Iterable[str] = ()
    ) -> "PexRequirements":
...
class PexInterpreterConstraints:
    ...
    @classmethod
    def create_from_adaptors(
        cls, adaptors: Tuple[PythonTargetAdaptor, ...], python_setup: PythonSetup
...
def create_pex(
  ...
  interpreter constraints."""
    ...
    result = yield Get(
        ExecuteProcessResult, MultiPlatformExecuteProcessRequest, execute_process_request
    )
    yield Pex(
