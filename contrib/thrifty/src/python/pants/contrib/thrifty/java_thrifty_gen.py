...
class JavaThriftyGen(NailgunTaskBase, SimpleCodegenTask):
    ...
    def register_options(cls, register):
        ...
        cls.register_jvm_tool(
            register, "thrifty-runtime", classpath=[thrifty_jar(name="thrifty-runtime")]
        )
        cls.register_jvm_tool(
            register, "thrifty-compiler", classpath=[thrifty_jar(name="thrifty-compiler")]
        )
    ...
    def execute_codegen(self, target, target_workdir):
        ...
        if args:
            result = self.runjava(
                classpath=self.tool_classpath("thrifty-compiler"),
