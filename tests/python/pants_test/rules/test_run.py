...
class RunTest(ConsoleRuleTestBase):
    ...
    def single_target_run(self, *, console: MockConsole, program_text: bytes, spec: str):
        ...
        bfa = BuildFileAddress(
            build_file=None, target_name=address.target_name, rel_path=f"{address.spec_path}/BUILD"
        )
    ...
    def test_normal_run(self) -> None:
        ...
        res = self.single_target_run(console=console, program_text=program_text, spec="some/addr")
