...
class ExportTest(ConsoleTaskTestBase):
    ...
    def test_source_globs_py(self):
        ...
        self.assertEqual(
            {"globs": ["src/python/x/*.py"]}, result["targets"]["src/python/x:x"]["globs"]
        )
    ...
    def test_source_globs_alias(self):
        ...
        self.assertEqual({"globs": []}, result["targets"]["src:alias"]["globs"])
    ...
    def test_no_libraries(self):
        ...
        self.assertEqual([], result["targets"]["project_info:java_test"]["libraries"])
    ...
    def test_java_test(self):
        ...
        self.assertEqual(
            ["org.apache:apache-jar:12.12.2012", "junit:junit:{}".format(JUnit.LIBRARY_REV)],
            result["targets"]["project_info:java_test"]["libraries"],
        )
        self.assertEqual(
            "TEST_RESOURCE", result["targets"]["project_info:test_resource"]["target_type"]
        )
    ...
    def test_top_dependency(self):
        ...
        self.assertEqual(
            ["project_info:jvm_binary"], result["targets"]["project_info:top_dependency"]["targets"]
        )
        ...
        self.assertEqual(
            {
                ...
                "exclude": [{"globs": ["src/python/exclude/foo.py"]}],
            },
