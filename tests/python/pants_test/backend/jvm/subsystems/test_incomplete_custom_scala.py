...
class IncompleteCustomScalaIntegrationTest(PantsRunIntegrationTest):
    ...
    def test_working_210(self):
        with self.tmp_scalastyle_config() as scalastyle_config_option:
            ...
            assert re.search(
                "Bootstrapping scalastyle_2_10", pants_run.stdout_data
    ...
    def test_working_211(self):
        with self.tmp_scalastyle_config() as scalastyle_config_option:
            ...
            self.assert_success(pants_run)
            assert re.search(
                "Bootstrapping scalastyle_2_11", pants_run.stdout_data
            ), pants_run.stdout_data
    ...
    def test_working_212(self):
        with self.tmp_scalastyle_config() as scalastyle_config_option:
            ...
            self.assert_success(pants_run)
            assert re.search(
                "Bootstrapping scalastyle_2_12", pants_run.stdout_data
            ), pants_run.stdout_data
