...
class JvmPlatformIntegrationMixin:
    ...
    def assert_class_versions(self, expected, received):
        ...
        self.assertEqual(
            ...
            "Compiled class versions differed.\n  expected: {}\n  received: {}".format(
                format_dict(expected), format_dict(received)
            ),
        )
    ...
    def test_compile_target_coercion(self):
        ...
        self.assert_class_versions(
            ...
            self._get_compiled_class_versions(
                target_spec,
                more_args=[
        ...
        with temporary_dir(root_dir=os.path.abspath(".")) as tmpdir:
            ...
            with self.temporary_workdir() as workdir:
                ...
                self.assert_success(
                    ...
                    "Diamond.java failed to compile in java7, " "which it should be able to.",
                )
