...
class TestJvmDependencyUsage(TaskTestBase):
    ...
    def _setup(self, target_classfiles):
        ...
        classpath_products = context.products.get_data(
    ...
    def test_dep_usage_graph_with_synthetic_targets(self):
        ...
        t2 = self.make_java_target(
            spec=":t2", sources=["a.java", "b.java"], dependencies=[t1, t1_x, t1_y, t1_z]
        )
    ...
    def test_target_alias(self):
        ...
        c = self.make_java_target(
            spec=":c", sources=["c.java"], dependencies=[alias_a_b, nested_alias_b]
        )
    ...
    def create_graph(self, task, targets):
        ...
        return DependencyUsageGraph(
            task.create_dep_usage_nodes(targets, node_creator),
