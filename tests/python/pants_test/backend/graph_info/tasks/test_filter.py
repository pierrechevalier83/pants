...
class FilterTest(BaseFilterTest):
    ...
    def test_nodups(self):
        ...
        self.assert_console_output("common/b:b", targets=targets)
    ...
    def test_filter_regex(self):
        ...
        self.assert_console_raises(
            TaskError, targets=self.targets("::"), options={"regex": ["abc)"]}
        )

    def test_filter_tag_regex(self):
        # Filter two.
        self.assert_console_output(
            "overlaps:three", targets=self.targets("::"), options={"tag_regex": ["+e(?=e)"]}
        )
        ...
        # Invalid regex.
        self.assert_console_raises(
            TaskError, targets=self.targets("::"), options={"tag_regex": ["abc)"]}
        )
