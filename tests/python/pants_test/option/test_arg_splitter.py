...
class ArgSplitterTest(unittest.TestCase):
    ...
    def test_distinguish_goals_from_target_specs(self):
        ...
        self._split(
            "./pants compile test:test", ["compile"], {"": [], "compile": []}, ["test:test"]
        )
    ...
    def test_subsystem_flags(self):
        ...
        self._split(
            ...
            ["test"],
            {"": [], "jvm.test.junit": ["--options=-Dbar=baz"], "test": []},
            ["foo:bar"],
        )
        ...
        self._split(
            ...
            ["test"],
            {"": [], "jvm.test.junit": ["--options=-Dbar=baz"], "test.junit": []},
            ["foo:bar"],
        )
        ...
        self._split(
            ...
            ["test"],
            {"": [], "reporting": ["--template-dir=path"], "test.junit": []},
            ["foo:bar"],
        )
    ...
    def test_help_detection(self):
        ...
        self._split_help("./pants --help", [], {"": []}, [])
        self._split_help("./pants goal --help", [], {"": []}, [])
        self._split_help("./pants help compile -x", ["compile"], {"": [], "compile": ["-x"]}, [])
        self._split_help("./pants help compile -x", ["compile"], {"": [], "compile": ["-x"]}, [])
        self._split_help("./pants compile -h", ["compile"], {"": [], "compile": []}, [])
        self._split_help(
        ...
        self._split_help(
            "./pants test src/foo/bar:baz -h", ["test"], {"": [], "test": []}, ["src/foo/bar:baz"]
        )
        ...
        self._split_help(
            "./pants help-advanced compile", ["compile"], {"": [], "compile": []}, [], True, False
        )
        self._split_help(
